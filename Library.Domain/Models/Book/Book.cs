namespace Library.Domain.Models.Book {
    public abstract class Book: IEquatable<Book> {
        ...
        internal protected Book( int id, string title, string genre, string description, string ISBN, Author author ) {
            Id = id;
        ...
        public abstract TakenBook Take( int clientId, TimeSpan periodOfUse );
        public abstract FreeBook Free( int clientId );
